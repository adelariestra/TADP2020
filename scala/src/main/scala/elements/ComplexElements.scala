...
case object escala extends Parser[EscalaTr] {
  ...
  def obtainFigure(result: ResultadoParseo[((Double,Double), FigureTr)]) = {
...
case object rotacion extends Parser[RotacionTr] {
  ...
  def obtainFigure(result: ResultadoParseo[((Int), FigureTr)]) = {
...
case object traslacion extends Parser[TraslacionTr] {
  ...
  def obtainFigure(result: ResultadoParseo[((Int,Int), FigureTr)]) = {
...
case object color extends Parser[ColorTr] {
  ...
  def obtainFigure(result: ResultadoParseo[(((Int,Int),Int), FigureTr)]) = {
